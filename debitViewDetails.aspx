<%@ Page Language="C#" AutoEventWireup="true" CodeFile="debitViewDetails.aspx.cs" Inherits="debitViewDetails" %>
     ...
     <td>
        <asp:GridView ID="gvViewDetails" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <ItemTemplate>
                <img align="right" src="debitViewDetails.ashx?id=<%# Eval("DBMT_SNO").ToString() %>&oraConn=<%# Session["constring"].ToString()%>" width="600" height="400" alt="" />
                </ItemTemplate>
