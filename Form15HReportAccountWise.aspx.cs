 ...
 * 1.1        Harshith        20.07.2015       Venkatesh 
 * -----------------------------------------------------------------------
 * -----------------------------PSEUDOCODE--------------------------------
...
public partial class Form15HReportAccountWise : System.Web.UI.Page
{
    Log objLog = new Log();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            objLog.WriteLog("Form15HReportAccountWise ->Page_Load(): Unable to load...." + ex.Message);
        ...
        objLog.WriteLog("Form15HReportAccountWise:Page Loaded Successfully");
    }
    ...
    protected void getBankDet()
    {
        ...
        objLog.WriteLog("Inside Form15HReportAccountWise->getBankDet()->BankInfo query" + dtBankDet.Rows.Count);
        if (dtBankDet.Rows.Count > 0)
        {
            Session["dtBankDet"] = dtBankDet;
            if ((!DBNull.Value.Equals(dtBankDet.Rows[0]["BAN_NAME"].ToString())))
            {
                objLog.WriteLog("Form15HReportAccountWise dtBankDet(BAN_NAME)" + dtBankDet.Rows[0]["BAN_NAME"].ToString());
            ...
            {
                objLog.WriteLog("Form15HReportAccountWise dtBankDet(BAN_ADDRESS1)" + dtBankDet.Rows[0]["BAN_ADDRESS1"].ToString());
            ...
            objLog.WriteLog("Form15HReportAccountWise->getBankDet()->Bankinfo executed successfully");
        }
        else
        {
    ...
    protected void getClientDet()
    {
        ...
        objLog.WriteLog("Form15HReportAccountWise->getClientDet()->executed successfully");
    }
