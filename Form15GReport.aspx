<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form15GReport.aspx.cs" Inherits="Form15GReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>FORM15G REPORT</title>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <asp:Panel ID="Panel2" runat="server">
                ...
                <table class="style1">
                 ...
                 <tr>
                     <td class="style7">
                         Declaration under section 197A(1) and section 197A(1A) of the Income-tax Act, 
                         1961 to be made by an individual or a person (not being a company or </td>
                 </tr>
                 <tr>
                     <td class="style7">
                         firm) claiming certain receipts without deduction of tax.</td>
                 </tr>
                    <tr>
                        <td>
                            &nbsp;</td>
            ...
            <table class="style1">
                <tr>
                    <td rowspan="2" style="border-style: dotted; border-width: thin" class="style2" 
                ...
                <tr>
                    <td style="border-style: dotted; border-width: thin" class="style2" 
                        ...
                        4] Flat / Door / Block No. :<br /> &nbsp;<asp:Label ID="lblAddress1" runat="server" 
                            Font-Bold="True"></asp:Label>
                    </td>
                    <td class="style2" style="border-style: dotted; border-width: thin" 
                        valign="top" rowspan="2">
                        5] Name of Premises :</td>
                ...
                <tr>
                    <td class="style2" colspan="2" style="border-style: dotted; border-width: thin" 
                        valign="top">
                        18] Residental status(within the<br /> meaning of section 6 of the Income Tax<br /> 
                        Act,1961)</td>
                    <td class="style2" colspan="2" style="border-style: dotted; border-width: thin" 
                        valign="top">
                        &nbsp;</td>
                ...
                <tr>
                    ...
                    <td class="style2" colspan="4" style="border-style: dotted; border-width: thin" 
                        valign="top">
                        20] Present AO Code (if not same as above):</td>
                </tr>
                <tr>
                    <td colspan="2" style="border-style: dotted; border-width: thin" class="style2" 
                        valign="top" rowspan="2">
                        21] Jurisdictional Chief Comm. of Income Tax or Comm. of Income Tax<br /> (if 
                ...
                <tr>
                    <td colspan="3" style="border-style: dotted; border-width: thin" class="style2" 
                        valign="top">
                        22] Estimated total income from the sources mentioned below:<br /> </td>
                ...
                <tr>
                    <td colspan="3" style="border-style: dotted; border-width: thin" class="style4" 
                        valign="top">
                        Dividend from shares referred to in Schedule - I</td>
                    <td class="style2" colspan="3" style="border-style: dotted; border-width: thin" 
                        valign="top">
                ...
                <tr>
                    <td colspan="3" style="border-style: dotted; border-width: thin" class="style4"" 
                        valign="top">
                        Interest on securities referred to in Schedule - II</td>
                    <td class="style2" colspan="3" style="border-style: dotted; border-width: thin" 
                        valign="top">
                ...
                <tr>
                    <td colspan="3" style="border-style: dotted; border-width: thin" class="style4" 
                        valign="top">
                        Income form units referred to in Schedule - IV</td>
                    <td class="style2" colspan="3" style="border-style: dotted; border-width: thin" 
                        valign="top">
                ...
                <tr>
                    <td colspan="3" style="border-style: dotted; border-width: thin" class="style4" 
                        valign="top">
                        The amt of withdrawal referred in clause(a) of sub-sec-2 of sec-80CCA referred 
                        in Schedule - V</td>
                    <td class="style2" colspan="3" style="border-style: dotted; border-width: thin" 
                        valign="top">
                ...
                <tr>
                    <td colspan="3" style="border-style: dotted; border-width: thin" class="style2" 
                        valign="top">
                        23]Estimated total income of the previous year in income mentioned in col - 21 
                        to be included :</td>
                    <td class="style2" colspan="3" style="border-style: dotted; border-width: thin" 
                        valign="top">
                ...
                <tr>
                    <td colspan="6" style="border-style: dotted; border-width: thin" class="style2" 
                        valign="top">
                        24] Details of investments in respect of which the declaration is being made :</td>
                </tr>
                <tr>
